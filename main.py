...
try: # 예외 처리
    ...
    error_logs = [line for line in l if "Oxygen tank unstable" in line or "Oxygen tank explosion" in line]
    ...
    if error_logs:
        ...
        print("\n문제가 되는 로그를 '{error_log_file}' 파일로 저장되었습니다.")

except FileNotFoundError: # 파일이 존재하지 않을 때 발생하는 오류
    print("error: 로그 파일 '{log_file_path}' 을(를) 찾을 수 없습니다.")
